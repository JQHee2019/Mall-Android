...
public class MeituanGridViewAdapter extends BaseAdapter {
    ...
    public MeituanGridViewAdapter(Context context, List<MeituanBean> mDatas, int curIndex, int pageSize) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_meituan_gridview, parent, false);
